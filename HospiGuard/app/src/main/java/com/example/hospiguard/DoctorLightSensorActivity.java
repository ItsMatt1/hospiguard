...
public class DoctorLightSensorActivity extends AppCompatActivity implements SensorEventListener {
        ...
        new Thread(() -> {
            try {
                ...
                client.toAsync().subscribeWith()
                        ...
                        .callback(msg -> {
                            // Update the light value based on the received MQTT message
